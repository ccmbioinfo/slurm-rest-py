...
**environment** | **{str: (bool, date, datetime, dict, float, int, list, str, none_type)}** | Dictionary of environment entries. | [optional] 
**exclusive** | **bool, date, datetime, dict, float, int, list, str, none_type** |  | [optional] 
...
**nodes** | **bool, date, datetime, dict, float, int, list, str, none_type** |  | [optional] 
